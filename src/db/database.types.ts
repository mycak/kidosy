...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      email_logs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "email_logs_offer_id_fkey"
            columns: ["offer_id"]
            isOneToOne: false
      ...
      offer_duplicates: {
        ...
        Relationships: [
          {
            foreignKeyName: "offer_duplicates_offer_id_1_fkey"
            columns: ["offer_id_1"]
            isOneToOne: false
            referencedRelation: "offers"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "offer_duplicates_offer_id_2_fkey"
            columns: ["offer_id_2"]
            isOneToOne: false
            referencedRelation: "offers"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "offer_duplicates_reviewed_by_fkey"
            columns: ["reviewed_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      offers: {
        ...
        Relationships: [
          {
            foreignKeyName: "offers_moderated_by_fkey"
          ...
          {
            foreignKeyName: "offers_offer_type_id_fkey"
    ...
    Functions: {
      ...
      archive_expired_offers: { Args: never; Returns: undefined }
